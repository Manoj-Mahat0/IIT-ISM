                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //   child: TextFormField(
                        //     controller:
                        //         MobileController, // Change this to a controller for the User ID
                        //     keyboardType: TextInputType.text,
                        //     textInputAction: TextInputAction.next,
                        //     autofillHints: [
                        //       AutofillHints.username
                        //     ], // Use the username autofill hint
                        //     onFieldSubmitted: (_) {
                        //       // FocusScope.of(context)
                        //       //     .requestFocus(_passwordFocusNode);  // You might want to shift focus to the password field
                        //     },
                        //     // validator: (value) => _userIdValidation(value.toString()),  // You should create a validation method for user ID
                        //     obscureText: false, // No need to obscure user ID
                        //     decoration: InputDecoration(
                        //       filled:
                        ...
                        //       prefixIcon: Icon(
                        //         Icons
                        //             .account_circle, // Change the icon to something more suitable for User ID
                        //         color: ColorConstant.black900, // Icon color
                        //       ),
                        //       labelText:
                        //           'Enter User ID', // Label text for the user ID field
                        //       labelStyle: TextStyle(
                        //         color: ColorConstant
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            textCapitalization: TextCapitalization
                                .characters, // Converts input to uppercase
                            onChanged: (value) {
                              // Automatically update the text to uppercase
                            ...
                            decoration: InputDecoration(
                              ...
                              border: OutlineInputBorder(
                                borderSide:
                                    BorderSide(color: ColorConstant.ismcolor),
                                borderRadius: BorderRadius.circular(8.0),
                              ),
                              enabledBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color: ColorConstant.ismcolor, width: 1),
                                borderRadius: BorderRadius.circular(8.0),
                              ),
                              focusedBorder: OutlineInputBorder(
                                borderSide: BorderSide(
    ...
    if (profiles.isNotEmpty) {
      ...
      try {
        ...
        if (mobileNumber.isEmpty) {
          _showSnackBar(context, 'Please enter a User ID');
          setState(() {
            isload = true;
          });
          return;
