// ignore_for_file: camel_case_types, prefer_final_fields, unnecessary_import, use_key_in_widget_constructors, prefer_const_constructors, prefer_const_literals_to_create_immutables, unused_local_variable, unnecessary_null_comparison
...
class _Session_SetScreenState extends State<Session_SetScreen> {
  ...
  Future<void> _LoadAssignClass(String sessions, String sessionyears) async {
    setState(() {
      isLoading = true;
    });
    ...
    try {
      ...
      if (sessions != '') {
        preferences.remove('session');
        await preferences.setString('session', sessions);
      }
      if (sessionyears != '') {
        preferences.remove('sessionyear');
        await preferences.setString('sessionyear', sessionyears);
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: isLoading
            ...
            : (sessionlist.isNotEmpty && sessionyearlist.isNotEmpty)
                ? Column(
                    children: [
                      Container(
                          ...
                          children: [
                            ...
                            DropdownButtonHideUnderline(
                              child: DropdownButton<SessionYear>(
                                ...
                                items: sessionyearlist
                                    .map<DropdownMenuItem<SessionYear>>(
                                        (SessionYear value) {
                ...
                : Center(
                    child: Text("Session & Session Year Not Found"),
                  ));
    // } else {
    //   return Scaffold(
    //     appBar: AppBar(
