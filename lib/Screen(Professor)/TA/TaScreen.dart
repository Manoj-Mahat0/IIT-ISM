...
import 'package:ism/Screen(Professor)/TA/SujectTA_Details.dart';
...
class _TAScreenState extends State<TAScreen> {
  ...
  String? _validateAdmissionNo(String? value) {
    if (value == null || value.isEmpty) {
      return 'Admission No. cannot be empty';
    }
    // Add more validation logic here if needed, e.g., length check, format check, etc.
    return null;
  }
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (CourseList[index].section != null)
                                        Text(
                                            'Section : ' +
                                        ...
                                        onPressed: () {
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                  Subject_TAScreen(
                                                sub_of: CourseList[index]
                                                    .subOfferedId
                                                    .toString(),
                                                sub_code: CourseList[index]
                                                    .subId
                                                    .toString(),
...
*/
  Future<void> Add_TA(String admn_no, ft_id, sub_offered_id, sub_code) async {
    try {
      ...
      // Conditionally set the URL based on isNEP value
      final Uri uri = isNEP
          ? Uri.parse('${ApiConstants.baseUrl}Add_TA') // If isNEP is true
