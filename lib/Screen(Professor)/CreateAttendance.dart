...
class _CreateAttendanceState extends State<CreateAttendance> {
  ...
  void LocationVerify() async {
    ...
    try {
      ...
      setState(() {
        ...
        lalog = true; // Location fetched successfully
      });
  ...
  Future<Position> _determinePosition() async {
    ...
    // Fetch the current position with the highest accuracy
    Position position = await Geolocator.getCurrentPosition(
      desiredAccuracy: LocationAccuracy.bestForNavigation,
      forceAndroidLocationManager: true, // Ensures better results on Android
    );

    // Print the location for debugging
    print('Latitude: ${position.latitude}');
    print('Longitude: ${position.longitude}');
    print('Accuracy: ${position.accuracy} meters'); // Debug accuracy
