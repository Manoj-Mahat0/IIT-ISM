// ignore_for_file: camel_case_types, prefer_final_fields, unnecessary_import, use_key_in_widget_constructors, prefer_const_constructors, prefer_const_literals_to_create_immutables, unused_local_variable, non_constant_identifier_names, unused_import
...
class Subject_Wise_ReportCount_TA extends StatefulWidget {
  ...
  _Subject_Wise_ReportCount_TAState createState() =>
      _Subject_Wise_ReportCount_TAState();
}

class _Subject_Wise_ReportCount_TAState
    extends State<Subject_Wise_ReportCount_TA> {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => DatewiseReportScreen(
                                      ...
                                      section:
                                          CourseList[index].section.toString(),
                                      course:
                                          CourseList[index].sub_name.toString(),
                                    )),
                          );
                        },
                        child: Container(
