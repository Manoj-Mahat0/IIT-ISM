...
class CustomDrawerTA extends StatefulWidget {
  @override
  State<CustomDrawerTA> createState() => _CustomDrawerTAState();
}

class _CustomDrawerTAState extends State<CustomDrawerTA> {
  File? _image;
  @override
  void initState() {
    super.initState();
                  ...
                  DrawerHeader(
                    ...
                    child: Column(
                      children: [
                        ...
                        if (name == '')
                          Text('Ta', style: TextStyle(color: Colors.white)),
                      ],
                    ),
                  ),
                  // SizedBox(
