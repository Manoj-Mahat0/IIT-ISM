...
class TA_Dealy_AttendanceScreen extends StatefulWidget {
  String sub_offered_id, priods, dates, proId;
  DateTime date;

  TA_Dealy_AttendanceScreen(
  ...
  @override
  _TA_Dealy_AttendanceScreenState createState() =>
      _TA_Dealy_AttendanceScreenState();
}

class _TA_Dealy_AttendanceScreenState extends State<TA_Dealy_AttendanceScreen> {
  String totalStudent = '';
  String _search = '';
  String? _classtime;
  ...
  Future<void> _LoadAssignClass() async {
    ...
    try {
      ...
      final Uri uri = isNEP
          ? Uri.parse(
              '${ApiConstants.baseUrl}nep_class_periods_AttendanceList_getReport_TA') // If isNEP is true
          : Uri.parse(
              '${ApiConstants.baseUrl}class_periods_AttendanceList_getReport_TA'); // If isNEP is false

      // final Uri uri = Uri.parse(
      //     '${ApiConstants.baseUrl}class_periods_AttendanceList_getReport_TA');
      final Map<String, String> headers = {
        'Accept': 'application/json',
        'Authorization': 'Bearer $token',
        'Content-Type': 'application/json',
  ...
  Future<void> UpdateStatus(String adminNo, String classpriods, String Status,
    ...
    try {
      ...
      final Uri uri = isNEP
          ? Uri.parse(
              '${ApiConstants.baseUrl}nep_EditAttendanceStatus_byTA') // If isNEP is true
          : Uri.parse(
              '${ApiConstants.baseUrl}EditAttendanceStatus_byTA'); // If isNEP is false

      // final Uri uri =
      //     Uri.parse('${ApiConstants.baseUrl}EditAttendanceStatus_byTA');
      final Map<String, String> headers = {
        'Accept': 'application/json',
        'Authorization': 'Bearer $token',
        'Content-Type': 'application/json',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      drawer: CustomDrawerTA(), // Replace with your custom drawer
      appBar: AppBar(
        title: Text(
