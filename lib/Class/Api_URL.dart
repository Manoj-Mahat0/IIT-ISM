...
class ApiConstants {
  static const String baseUrl = 'https://apps.iitism.ac.in/newtest/api/';
  static const String baseUrllogin = 'apps.iitism.ac.in';
  static const String endpointotp = '/newtest/Admin_sendOTP';
  static const String endpointotpnew = '/newtest/api/newPassword_verify';
  // static const String endpointotpnew = '/api/Password_verify';
  static const String endpointverify = '/newtest/api/Admin_verifyOTP';
}
...
//   static const String endpointotpnew = '/api/newPassword_verify';
//   // static const String endpointotpnew = '/api/Password_verify';
