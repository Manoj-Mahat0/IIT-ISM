// ignore_for_file: prefer_const_constructors, prefer_is_empty, non_constant_identifier_names, unused_local_variable, empty_catches, avoid_types_as_parameter_names, depend_on_referenced_packages, unused_import
          ...
          return MultiProvider(
            ...
            child: MaterialApp(
              builder: (context, child) {
                // Wrap the app with MediaQuery to fix text scaling
                return MediaQuery(
